                ...
                >
                  <div className="rounded-xl overflow-hidden shadow-lg">
                    {hasFullConsent ? (
                      ...
                      <div
                        className="block bg-white rounded-xl p-6 text-center h-[500px] flex flex-col items-center justify-center"
                        style={{
                          boxShadow: isCenter
                            ? "0 8px 30px rgba(0,0,0,0.2)"
                            : "0 4px 15px rgba(0,0,0,0.1)",
                      ...
                      >
                        <div className="w-20 h-20 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-2xl flex items-center justify-center mb-4">
                        ...
                        <p className="text-gray-800 font-semibold mb-2">Instagram-Inhalt nicht verfügbar</p>
                        <p className="text-sm text-gray-500 mb-4 max-w-[250px]">
                          Dieser Inhalt kann nicht angezeigt werden, da externe Cookies nicht akzeptiert wurden.
                        </p>
                        <button
                          onClick={openConsentModal}
                          className="px-6 py-2 bg-[#7D6B5D] text-white text-sm font-medium rounded-full hover:bg-[#6B5A4D] transition"
                        >
                          Cookies aktivieren
                        </button>
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-3 text-xs text-[#A68A75] hover:underline"
                        >
